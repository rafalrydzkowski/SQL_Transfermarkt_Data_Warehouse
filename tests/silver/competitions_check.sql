...
/* CHECK 02: Business Logic - Major League Integrity
  ...
  Findings: If multiple leagues are flagged as 'true', it indicates 
            a configuration error in the source data.
*/
...
/* CHECK 03: Data Standardization & String Integrity
  ...
  Fix: All identified fields will be sanitized using TRIM().
*/
...
/* CHECK 04: Categorical Consistency & Data Type Planning
  Description: Verifies distinct values to plan Silver Layer casting.
  
  Findings: 
    - 'is_major_national_league' is currently string ('true'/'false').
    - 'sub_type' naming for qualifiers is inconsistent.
  
  Silver Strategy: 
    - Cast 'is_major_national_league' to BOOLEAN.
    - Standardize 'sub_type' (e.g., suffixing all qualifiers with '_qualifying').
*/
